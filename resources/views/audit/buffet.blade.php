    ...
    <div class="row mb-2">
        <div class="col-12">
            <ul class="nav nav-tabs justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"  href="#" role="button" aria-expanded="false">Buffet</a>
...
@section('js')
    ...
    <script>
        ...
        this.livewire.on('deleteBuffet', BuffetId => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    livewire.emitTo('audit.buffet-index', 'delete', BuffetId);
                    swalWithBootstrapButtons.fire(
                        'Eliminado!',
