...
<div class="row py-2">
    ...
    <div id="date2" class="invisible d-none">
        <div class="small-box bg-info">
            {!! Form::model('chart', ['route' => ['dashboard.update'], 'method' => 'post']) !!}
            <div class="inner p-2">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-footer text-center">
                <a href="{{ route('xmls.show', $dataYear['id'][0]) }}" class="btn btn-sm btn-dark">
                    Ver Detalles
                </a>
            </div>
        </div>
    ...
    var weekChart4 = new Chart(document.getElementById('week-4-chart-canvas').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: 'rgba(150, 165, 164, 1)',
                backgroundColor: 'rgba(150, 165, 164, 0.5)',
                borderWidth: 1
            },
            {
                label: 'ARR',
                ...
                borderColor: 'rgba(50, 191, 186, 1)',
                backgroundColor: 'rgba(50, 191, 186, 0.5)',
                borderWidth: 1
            }]
        },
        options: {
    ...
    var yearChart2 = new Chart(document.getElementById('year-day-2-chart-canvas').getContext('2d'), {
        ...
        data: {
            ...
            },
            {
                ...
                borderColor: 'rgba(122, 186, 122, 1)',
                backgroundColor: 'rgba(122, 186, 122, 0.5)',
            },
            {
                label: 'Año',
                data: [
                ...
                borderColor: 'rgba(183, 110, 184, 1)',
                backgroundColor: 'rgba(183, 110, 184, 0.5)',
            }]
        },
        options: {
            maintainAspectRatio: false,
