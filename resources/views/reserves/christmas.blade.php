    ...
    <div class="row mb-2">
        <div class="col-12">
            <ul class="nav nav-tabs justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"  href="#" role="button" aria-expanded="false">Navidad</a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('reserves.dinners.newYear') }}">Año Nuevo</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
@section('content')
    <div class="row justify-content-center">
        @livewire('reserves.christmas.christmas-index')
    </div>
@stop
        ...
        this.livewire.on('deleteReserve', orderId => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    livewire.emitTo('reserves.christmas.christmas-index', 'delete', orderId);
                    swalWithBootstrapButtons.fire(
                        'Eliminado!',
