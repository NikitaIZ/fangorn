...
<div>
    <div wire:ignore.self class="modal fade" id="updatePosition" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="bg-dark modal-header">
                    <h5 class="modal-title" >
                        ...
                        @if($readyToLoad)
                            Modificar {{$position_object->name}}
                        @endif
                    </h5>
                        ...
                        @if($readyToLoad)
                            <form wire:submit.prevent="update"> 
                                <div class="mb-3">
                                    ...
                                    <input value="{{$cargo}}" wire:loading.attr="disabled" style="color:white;" wire:model.defer="cargo" type="text" name="area" class="form-control" id="area_name" placeholder="Nombre del area">
                                </div>
                                <div class="mb-3">
