<div>
    <!-- Modal -->
    <button data-bs-toggle="modal" data-bs-target="#addArea" class="btn btn-info  btn-large add-button-box rounded-0">
        <i class="fa-solid fa-plus fa-sm"></i>
    </button>
    <div wire:ignore.self class="modal fade" id="addArea" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-body bg-dark">
                    ...
                    <form wire:submit.prevent="save"> 
                        <div class="mb-3">
                            ...
                            <input wire:loading.attr="disabled" style="color:white;" wire:model.defer="area" type="text" name="area" class="form-control" id="area_name" placeholder="Nombre del area">
                        </div>
                        <div class="mb-3">
