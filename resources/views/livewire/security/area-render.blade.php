        ...
        <div class="  rounded search-box border-secondary container-fluid d-flex align-items-center m-0 p-0  rounded-0">
            ...
            <div class="border-0 m-0 p-0 ">
                <div class="container p-0">
                    <a href="{{route('security.area.register.get')}}" class="btn btn-info  btn-large add-button-box rounded-0">
                        ...
                        <td class="align-middle">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="{{route('security.area.update.get',$area->id)}}">
