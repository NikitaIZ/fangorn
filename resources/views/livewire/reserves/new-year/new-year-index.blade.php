<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="info-box">
            <span class="info-box-icon bg-gold elevation-1"><i class="fas fa-money-bill-wave"></i></span>
            <div class="info-box-content">
                <span class="info-box-text">Total</span>
                <span class="info-box-number" style="font-size: 0.75rem;">
    ...
    <div class="col-lg-3 col-6">
        <div class="info-box">
            <span class="info-box-icon bg-gold elevation-1"><i class="fas fa-file-invoice-dollar"></i></span>
            <div class="info-box-content">
    ...
    <div class="col-lg-3 col-6">
        <div class="info-box">
            <span class="info-box-icon bg-dark elevation-1"><i class="fas fa-male"></i></span>
            <div class="info-box-content">
    ...
    <div class="col-12">
        <div class="card" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;">
            ...
            <div class="card-body p-0" wire:init='loadBookings'>
                            ...
                            <tbody class="table-light">
                                @foreach ($bookings as $booking)
                                    @if ($booking->status == $this->status)
                                        <tr>
                                            <td scope="row">{{ $booking->order_id }}</td>
                                            ...
                                            <td class="text-center align-middle">{{ $booking->area }}</td>
                                            <td class="text-center align-middle">{{ $booking->created_at }}</td>
                                            <td width="10px" class="align-middle">
                                                <button class="btn btn-outline-gold" data-bs-toggle="modal" data-bs-target="#Modal{{ $booking->order_id }}" wire:click="getDataTablesAndSeats({{ $booking->order_id }})"><i class="fa-solid fa-circle-info"></i></button>
                                                <div wire:ignore.self class="modal fade" id="Modal{{ $booking->order_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Modal{{ $booking->order_id }}Label" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer bg-gold">
                ...
                <div class="card-footer bg-dark father">
                    <div class="child">
