                ...
                <div class="card-header" style="background-color: #0c437d!important; color: white;">
                    ...
                    <div class="card-tools">
                        <ul class="nav nav-pills ml-auto">
                            <li class="nav-item">
                                <a class="nav-link wyndham mr-2 active" href="#week-graf-2" style="padding: 0.25rem 0.75em" data-bs-toggle="tab">1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link wyndham mr-2" href="#week-graf-3" style="padding: 0.25rem 0.75em" data-bs-toggle="tab">2</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link wyndham mr-2" href="#week-graf-4" style="padding: 0.25rem 0.75em" data-bs-toggle="tab">3</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content p-0">
                        <div class="chart tab-pane active" id="forecast-graf-2">
                            <div class="row">
                                <div class="card-tools pb-3">
                                    <ul class="nav nav-pills justify-content-center">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#month-occ-1" data-bs-toggle="tab">{{ $data["month"]["name"] }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="info-box bg-danger m-0">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Historico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["history"]["NPS"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="info-box bg-danger-off m-0" style="color: white;">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Pronostico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["forecast"]["NPS"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="info-box bg-danger m-0">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Total</span>
                                                                    <span class="info-box-number">{{ $data["month"]["total"]["NPS"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                        ...
                        <div class="chart tab-pane" id="forecast-graf-3">
                            <div class="row">
                                <div class="card-tools pb-3">
                                    <ul class="nav nav-pills justify-content-center">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#month-rooms-1" data-bs-toggle="tab">{{ $data["month"]["name"] }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content">
                                    <div class="chart tab-pane active" id="month-rooms-1">
                                        ...
                                        <table class="table table-borderless table-responsive m-0">
                                            <thead>
                                                <tr>
                                                    @foreach ($data["month"]["TOR"] as $names)
                                            ...
                                            <tbody>
                                                @if ($data["month"]["history"]["DYS"] > 0)
                                                    <tr>
                                                        @foreach ($data["month"]["TOR"] as $history)
                                                            <td scope="row">
                                                ...
                                                @if ($data["month"]["forecast"]["DYS"] > 0)
                                                    <tr>
                                                        @foreach ($data["month"]["TOR"] as $forecast)
                                                            <td scope="row">
                                                ...
                                                @if ($data["month"]["history"]["DYS"] > 0 && $data["month"]["forecast"]["DYS"] > 0)
                                                    <tr>
                                                        @foreach ($data["month"]["TOR"] as $total)
                                                            <td scope="row">
                        ...
                        <div class="chart tab-pane" id="forecast-graf-4">
                            <div class="row">
                                <div class="card-tools pb-3">
                                    <ul class="nav nav-pills justify-content-center">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#month-arrival-1" data-bs-toggle="tab">{{ $data["month"]["name"] }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content">
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="info-box m-0" style="background-color: rgb(27, 188, 155); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Historico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["history"]["ARR"] }}</span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>
                                                            <div class="info-box m-0" style="background-color: rgb(45, 62, 80); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Historico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["history"]["DEP"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="info-box m-0" style="background-color: rgb(27, 188, 155, 0.75); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Pronostico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["forecast"]["ARR"] }}</span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>
                                                            <div class="info-box m-0" style="background-color: rgb(45, 62, 80, 0.75); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Pronostico</span>
                                                                    <span class="info-box-number">{{ $data["month"]["forecast"]["DEP"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="info-box m-0" style="background-color: rgb(27, 188, 155); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Total</span>
                                                                    <span class="info-box-number">{{ $data["month"]["total"]["ARR"] }}</span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>
                                                            <div class="info-box m-0" style="background-color: rgb(45, 62, 80); color:white">
                                                                ...
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text">Total</span>
                                                                    <span class="info-box-number">{{ $data["month"]["total"]["DEP"] }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
console.log(@this.date);
            ...
            var forecast = forecast_array_one(report);
            var foretype = forecast_types_array_one(report);
