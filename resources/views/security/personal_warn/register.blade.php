    ...
    <div class="pt-3 pb-3">
        ...
        <div class="container-fluid">
            <div class="rounded-top container-fluid d-flex gap-2 bg-dark p-0 pt-3 pl-2 m-0 flex-column show-container-header">
                ...
                <h5 class="p-0 pb-3 m-0">Registro de Advertencia</h5>
            </div>
            <div class=" rounded-bottom container-fluid form-body bg-dark ">
                <form action="{{route('security.personal_warn.register.post',$personal->personal_id)}}" method="post" class="row g-3 pl-2 pr-2 pb-4 pt-2" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <input maxlength="64" type="text" name="razon" id="razon" class="form-control" placeholder="Razon">
                    </div>
                    <div class="col-md-12">
                        <label for="description" class="form-label">Descripcion</label>
                        <textarea maxlength="256" style="resize:none;" class="form-control" id="descripcion" name="descripcion" rows="4"></textarea>
                    </div>
