...
namespace App\Http\Livewire\Reserves\Christmas;
...
class ChristmasIndex extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.reserves.christmas.christmas-index', compact('total', 'bookings'));
    }
    ...
    public function delete($id)
    {
        ...
        $this->emitTo('reserves.christmas.christmas-index', 'render');
    }
    ...
    public function excel(){
        ...
        return Excel::download($export, "Navidad ". date('d-m-Y h_i A') . '.xlsx');
    }
}
